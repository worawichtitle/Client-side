...
const LEVELS = [
  {
    ...
    text: "#fff",
    description:
      "คุณภาพอากาศดี และมลพิษทางอากาศก็มีความเสี่ยงเพียงเล็กน้อยหรือไม่มีเลย",
  },
  {
    range: "51–100",
    label: "ปานกลาง",
    ...
    text: "#222",
    description:
      "คุณภาพอากาศยอมรับได้ แต่ผู้ที่ไวต่อมลพิษอาจมีความกังวลเรื่องสุขภาพ",
  },
  {
    range: "101–150",
    ...
    text: "#fff",
    description:
      "กลุ่มเสี่ยงอาจได้รับผลกระทบต่อสุขภาพ ประชาชนทั่วไปมักไม่ได้รับผลกระทบ",
  },
  {
    range: "151–200",
    label: "มีผลกระทบ",
    ...
    text: "#fff",
    description:
      "ทุกคนอาจเริ่มมีผลกระทบต่อสุขภาพ กลุ่มเสี่ยงจะมีอาการรุนแรงขึ้น",
  },
  {
    range: "201–299",
